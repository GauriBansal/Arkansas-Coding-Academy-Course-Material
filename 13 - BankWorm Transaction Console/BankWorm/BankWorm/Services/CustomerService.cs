...
namespace BankWorm.Services
{
    ...
    {
        private readonly List<OldCustomer> _customers;
        private readonly Random _random = new Random();

        public CustomerService()
        {
            _customers = new List<OldCustomer>
            {
                new OldCustomer
                {
                    Id = 101,
        ...
        public IEnumerable<OldCustomer> GetAllCustomers()
        {
            return _customers.ToList();
        }

        public OldCustomer GetCustomerById(int customerId)
        {
        ...
        public bool CreateDebitTransaction(OldCustomer customer, Account account, decimal amount, string memo)
        {
        ...
        public void CreateCreditTransaction(OldCustomer customer, Account account, decimal amount, string memo)
        {
        ...
        public bool RemoveAccount(OldCustomer customer, Account account)
        {
        ...
        public void UpdateAccount(OldCustomer customer, Account account, string newAcctName)
        {
            _customers.Remove(customer);
            customer.Accounts.Remove(account);
